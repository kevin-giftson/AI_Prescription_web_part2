...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function getPdfContent() {
        ...
        const medicationRows = Array.from(document.querySelectorAll('#medicationTable tbody tr')).map(row => {
            ...
            return {
                ...
                // Removed the 'dosage' property as it was incorrectly pulling button text
        ...
        return `
            <div id="prescription-content" class="pdf-container">
                <div class="header">
                    <img src="https://nizcare45.github.io/Mail/Assets/nizcare-logo.png" alt="Logo" class="logo">
    ...
    async function generateAndOpenPdf(action) {
        ...
        // Define PDF styles directly here, at the beginning of the function
        const pdfStyles = `
            <style>
